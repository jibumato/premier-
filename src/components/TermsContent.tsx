  ...
  return (
    <div>
      ...
      <Section title="4. フリマ（衣装売買）について">
        ...
        <Item>出品できるのは、出品者本人が正当に処分できる私物に限ります。</Item>
        <Item>
          次のものは出品できません：偽ブランド品・海賊版・無許諾の公式／二次創作グッズなど
          権利を侵害する物品、着用済みの下着など性的な文脈で取引される物品、医薬品・アルコール・
          その他法令で個人売買が制限された物品。
        </Item>
        <Item>
          代金は前払いのみを求めるなど、著しく不利な条件やアプリ外の決済へ誘導する取引には
          十分ご注意ください。
        </Item>
      </Section>
